...
const [score, setScore] = useState(0); // ✅ Start fresh each time

  const [selectedOption, setSelectedOption] = useState(null);
  const [currentQuestionIndex, setCurrentQuestionIndex] = useState(0);
  const [timeLeft, setTimeLeft] = useState(20); // ✅ 5 minutes countdown
  ...
  const handleSubmit = () => {
    ...
    setIsSubmitted(true); 
    navigate("/level2", { state: { level1Score: score } }); // ✅ Pass score to Level 2
};
